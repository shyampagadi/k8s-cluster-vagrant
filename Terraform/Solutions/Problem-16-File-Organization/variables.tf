# File Organization and Project Structure - Variables
...
# File Organization Specific Variables
variable "file_organization_pattern" {
  description = "File organization pattern to use"
  type        = string
  default     = "resource-based"
  
  validation {
    condition     = contains(["basic", "resource-based", "environment-based", "team-based"], var.file_organization_pattern)
    error_message = "File organization pattern must be basic, resource-based, environment-based, or team-based."
  }
}

variable "enable_module_organization" {
  description = "Enable module-based organization"
  type        = bool
  default     = false
}

variable "documentation_level" {
  description = "Level of documentation to include"
  type        = string
  default     = "comprehensive"
  
  validation {
    condition     = contains(["basic", "standard", "comprehensive"], var.documentation_level)
    error_message = "Documentation level must be basic, standard, or comprehensive."
  }
}

variable "version_control_integration" {
  description = "Enable version control integration features"
  type        = bool
  default     = true
}
