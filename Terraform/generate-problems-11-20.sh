...
How PROBLEM_TITLE integrates with various AWS services and features.
...
EOF
    ...
    sed -i "s/PROBLEM_NUM/$problem_num/g" "$problem_dir/COMPREHENSIVE-$(echo $problem_title | tr ' ' '-' | tr '[:lower:]' '[:upper:]')-GUIDE.md"
    sed -i "s/PROBLEM_TITLE/$problem_title/g" "$problem_dir/COMPREHENSIVE-$(echo $problem_title | tr ' ' '-' | tr '[:lower:]' '[:upper:]')-GUIDE.md"
    sed -i "s/PROBLEM_FOCUS/$problem_focus/g" "$problem_dir/COMPREHENSIVE-$(echo $problem_title | tr ' ' '-' | tr '[:lower:]' '[:upper:]')-GUIDE.md"
}

# Generate deliverables for Problems 11-20
...
echo "✅ Comprehensive guides created for Problems 11-20!"
